# Graph Report - menrosystem  (2026-09-23)

## Corpus Check
- 54 files · ~94,638 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 23 file(s) not represented in the graph (top: .css 20, (none) 2, .geojson 1)

## Summary
- 667 nodes · 1229 edges · 37 communities (30 shown, 7 thin omitted)
...
1. `PlantingPage()` - 49 edges
2. `useAuth()` - 39 edges
3. `MonitoringPage()` - 30 edges
4. `DashboardPage()` - 28 edges
5. `react` - 25 edges
6. `SitesPage()` - 25 edges
7. `MyRequestsPage()` - 24 edges
8. `MapVisualizationPage()` - 22 edges
9. `EventSchedulePage()` - 20 edges
10. `SeedlingRequestsPage()` - 20 edges
...
Cohesion: 0.07
Nodes (51): exifr, leaflet, calculateDistanceMeters(), displayReportStatus(), formatDate(), formatDateTime(), formatFileSize(), getCurrentUserIdentity() (+43 more)

### Community 1 - "SitesPage.jsx"
Cohesion: 0.07
Nodes (34): ref_leaflet_dist_leaflet_css, BARANGAYS, formatDate(), formatNumber(), getConditionColor(), getInitialSiteForm(), getSiteStatus(), getUtilization() (+26 more)

### Community 2 - "SeedlingRequestsPage.jsx"
Cohesion: 0.09
Nodes (40): ADMIN_REJECTION_REASONS, AdminDecisionModal(), apiRequest(), BARANGAYS, createRequestId(), formatDate(), formatLocalDateLabel(), formatTime() (+32 more)

### Community 3 - "MonitoringPage.jsx"
Cohesion: 0.10
Nodes (32): apiRequest(), buildMediaUrl(), CONDITION_META, deriveCondition(), formatDate(), formatDateTime(), formatFileSize(), getAuthToken() (+24 more)
...
Cohesion: 0.10
Nodes (29): BARANGAYS, EVENT_TYPES, EventForm(), EventSchedulePage(), apiRequest(), getAuthToken(), loadArchivedEvents(), loadEvents() (+21 more)
...
Cohesion: 0.09
Nodes (23): auth, apiRequest(), formatDateTime(), formatNumber(), getAuthToken(), getInitialForm(), normalizeInventoryItem(), NURSERY_OPTIONS (+15 more)
...
Cohesion: 0.05
Nodes (46): devDependencies, eslint, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, @types/node, @types/react (+38 more)
...
### Community 18 - "react"
Cohesion: 0.29
Nodes (3): react, GuestEventPage(), src_styles_guest_event

### Community 20 - "RegisterPage.jsx"
Cohesion: 0.25
Nodes (9): src_assets_menro_logo, CompleteProfilePage(), configuredApiUrl, localApiUrl, RegisterPage(), src_styles_register, JUBAN_BARANGAYS, USER_TYPES (+1 more)

### Community 21 - "Sidebar.jsx"
Cohesion: 0.11
...
- **Why does `useAuth()` connect `useAuth` to `PlantingPage`, `SitesPage.jsx`, `SeedlingRequestsPage.jsx`, `MonitoringPage.jsx`, `DashboardPage.jsx`, `EventSchedulePage.jsx`, `ReforestationAnalyticsPage.jsx`, `SeedlingsPage.jsx`, `ProfilePage.jsx`, `RegisterPage.jsx`, `Sidebar.jsx`, `ReportsPage.jsx`, `config.js`, `RootRedirect.jsx`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `PlantingPage`, `SitesPage.jsx`, `SeedlingRequestsPage.jsx`, `MonitoringPage.jsx`, `DashboardPage.jsx`, `EventSchedulePage.jsx`, `ReforestationAnalyticsPage.jsx`, `MapVisualizationPage.jsx`, `MyRequestsPage.jsx`, `SeedlingsPage.jsx`, `package.json`, `ProfilePage.jsx`, `App.jsx`, `useAuth`, `RegisterPage.jsx`, `Sidebar.jsx`, `ReportsPage.jsx`, `config.js`?**
