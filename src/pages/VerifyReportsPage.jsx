      ...
      prev.map((r) =>
        r.id === id
          ? {
              ...r,
              verificationStatus: "Approved",
              remarks: remarks || "Verified and approved.",
            }
          : r
      )
    );
      ...
      prev.map((r) =>
        r.id === id
          ? {
              ...
              remarks: remarks || "Report rejected.",
            }
          : r
      )
    );
  ...
  return (
    <div style={{ padding: "32px" }}>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        >
          {userRole === "admin"
            ? "Review, approve, or reject planting reports submitted by participants."
            : "Review assigned planting reports for verification."}
        </p>
      </div>
      ...
      {reports.filter(
        ...
        >
          ...
          <span>
            ...
            suspicious report(s) flagged for review.
          </span>
        </div>
      )}
                ...
                <td style={{ padding: "14px 16px" }}>
                  <span
                    style={{
                      ...
                      fontWeight: "600",
                      background:
                        FLAG_COLORS[r.aiFlag]?.bg,
                      color:
                        FLAG_COLORS[r.aiFlag]?.color,
                    }}
                  >
                    {r.aiFlag}
                  </span>
          ...
          >
            ...
            >
              {[
                ...
                {
                  label: "Participant",
                  value: selectedReport.participant,
                },
                {
                  label: "Barangay",
                  value: selectedReport.barangay,
                },
                {
                  label: "Site",
                  value: selectedReport.site,
                },
                {
                  label: "Species",
                  value: selectedReport.species,
                },
                {
                  label: "Quantity",
                  value: selectedReport.quantity,
                },
                {
                  label: "Date",
